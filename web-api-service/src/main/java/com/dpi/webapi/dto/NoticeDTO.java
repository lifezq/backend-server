...
public class NoticeDTO {
     ...
     * 租户号
     */
    @Schema(name = "租户ID", example = "1")
    private Integer tenantId;

    /**
     * 公告标题
     */
    @Schema(name = "公告标题", example = "标题")
    private String title;

    /**
     * 公告内容
     */
    @Schema(name = "公告内容", example = "内容")
    private String content;

    /**
     * 附件路径
     */
    @Schema(name = "附件上传", example = "附件文件")
    private String attachmentPath;

    /**
     * 推送对象 0未知,1平台角色,2指定用户,3全局
     */
    @Schema(name = "推送对象 0未知,1平台角色,2指定用户,3全局", example = "1")
    private Integer sendType;

    /**
     * 推送对象批量值
     */
    @Schema(name = "推送对象批量值", example = "")
    private String sendTypeValue;

    /**
     * 推送渠道 0未知, 1站内信,2短信,3邮件
     */
    @Schema(name = "推送渠道 0未知, 1站内信,2短信,3邮件", example = "1")
    private Integer sendChannel;

    /**
     * 推送时间
     */
    @Schema(name = "推送时间", example = "")
