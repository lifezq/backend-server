...
public class PushMessageConfigurationDTO {
     ...
     * 消息任务名称
     */
    @Schema(title = "消息任务名称", example = "")
    private String name;

    /**
     * 消息事件编码
     */
    @Schema(title = "消息事件编码", example = "")
    private String eventCode;

    /**
     * 消息类型编码id
     */
    @Schema(title = "消息类型编码id", example = "")
    private Integer messageType;

    /**
     * 是否可订阅, 0否,1是
     */
    @Schema(title = "是否可订阅, 0否,1是", example = "0")
    private Integer isSubscribe;

    /**
     * 消息模板id列表
     */
    @Schema(title = "消息模板id列表，多个以逗号分隔", example = "")
